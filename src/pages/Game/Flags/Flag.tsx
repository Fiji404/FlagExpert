...
export const Flag = memo(({ countryName, countryFlagURL, isCountryGuessed }: Props) => {
    ...
    return (
        <>
            ...
            <li
                className={`flex justify-center flex-col items-center bg-[#f8f8f8] dark:bg-[#161616] border border-[#e0e0e0] dark:border-[#222222] grow min-w-[50px] max-w-[120px] box-content px-3 py-2 rounded-md aspect-video ${
